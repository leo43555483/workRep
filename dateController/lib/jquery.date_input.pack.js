DateInput = (function($) {
    ...
    DateInput.prototype = {
        build: function() {
            ...
            timePeriod = '<div id="dateWrap">'+
            				'<div class="dateShow" id="noon"><a href="javascript:;">上午</a></div>'+
            			  	'<div class="dateShow" id="afternoon"><a href="javascript:;">下午</a></div>'+
            			  '</div>';
            this.dateSelector = this.rootLayers = $('<div class="date_selector" id="selector"></div>').append(nav, tableShell, timePeriod).insertAfter(this.input);
        ...
        selectMonth: function(date) {
            ...
            if (!this.currentMonth || !(this.currentMonth.getFullYear() == newMonth.getFullYear() && this.currentMonth.getMonth() == newMonth.getMonth())) {
                ...
                $(".selectable_day", this.tbody).click(this.bindToObj(function(event) {
                    ...
                    if($(target).hasClass("selectable_day")) {
        ...
        hideIfClickOutside: function(event) {
            console.log('target',event.target != this.input[0])
